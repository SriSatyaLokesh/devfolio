...
(function() {
  ...
  window.randomizeVanta = async function() {
    ...
    if (typeof window.DEV_FOLIO_VANTA_INDEX === 'undefined') {
      window.DEV_FOLIO_VANTA_INDEX = 0;
    } else {
      window.DEV_FOLIO_VANTA_INDEX = (window.DEV_FOLIO_VANTA_INDEX + 1) % VANTA_EFFECTS.length;
    }

    const nextEffect = VANTA_EFFECTS[window.DEV_FOLIO_VANTA_INDEX];
